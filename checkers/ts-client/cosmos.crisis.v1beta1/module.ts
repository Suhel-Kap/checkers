...
export const txClient = (
  ...
  return {
    async sendMsgVerifyInvariantResponse({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgVerifyInvariantResponse: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        ...
        let msg = this.msgVerifyInvariantResponse({
        ...
        throw new Error(
          "TxClient:sendMsgVerifyInvariantResponse: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    msgVerifyInvariantResponse({
      value,
    }: msgVerifyInvariantResponseParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:MsgVerifyInvariantResponse: Could not create message: " +
            e.message
        );
      }
    },
