...
export const txClient = (
  ...
  return {
    async sendParameterChangeProposal({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendParameterChangeProposal: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        ...
        let msg = this.parameterChangeProposal({
        ...
        throw new Error(
          "TxClient:sendParameterChangeProposal: Could not broadcast Tx: " +
            e.message
        );
      }
    },

    async sendParamChange({
      value,
      fee,
      memo,
    }: sendParamChangeParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendParamChange: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendParamChange: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendQuerySubspacesResponse({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendQuerySubspacesResponse: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.querySubspacesResponse({
        ...
        throw new Error(
          "TxClient:sendQuerySubspacesResponse: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    async sendSubspace({
      ...
      fee,
      memo,
    }: sendSubspaceParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendSubspace: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendSubspace: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendQuerySubspacesRequest({
      value,
      fee,
      memo,
    }: sendQuerySubspacesRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendQuerySubspacesRequest: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.querySubspacesRequest({
        ...
        throw new Error(
          "TxClient:sendQuerySubspacesRequest: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    parameterChangeProposal({
      value,
    }: parameterChangeProposalParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:ParameterChangeProposal: Could not create message: " +
            e.message
        );
      }
    },
    ...
    paramChange({ value }: paramChangeParams): EncodeObject {
      try {
        return {
          ...
          value: ParamChange.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:ParamChange: Could not create message: " + e.message
        );
      }
    },
    ...
    querySubspacesResponse({
      value,
    }: querySubspacesResponseParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QuerySubspacesResponse: Could not create message: " +
            e.message
        );
      }
    },
    ...
    subspace({ value }: subspaceParams): EncodeObject {
      try {
        return {
          ...
          value: Subspace.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:Subspace: Could not create message: " + e.message
        );
      }
    },
    ...
    querySubspacesRequest({
      value,
    }: querySubspacesRequestParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QuerySubspacesRequest: Could not create message: " +
            e.message
        );
      }
    },
