...
export const txClient = (
  ...
  return {
    async sendMinter({
      ...
      fee,
      memo,
    }: sendMinterParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMinter: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        ...
        throw new Error(
          "TxClient:sendMinter: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendQueryInflationResponse({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendQueryInflationResponse: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.queryInflationResponse({
        ...
        throw new Error(
          "TxClient:sendQueryInflationResponse: Could not broadcast Tx: " +
            e.message
        );
      }
    },

    async sendQueryInflationRequest({
      value,
      fee,
      memo,
    }: sendQueryInflationRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendQueryInflationRequest: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.queryInflationRequest({
        ...
        throw new Error(
          "TxClient:sendQueryInflationRequest: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    async sendQueryAnnualProvisionsRequest({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendQueryAnnualProvisionsRequest: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.queryAnnualProvisionsRequest({
        ...
        throw new Error(
          "TxClient:sendQueryAnnualProvisionsRequest: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    async sendQueryAnnualProvisionsResponse({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendQueryAnnualProvisionsResponse: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.queryAnnualProvisionsResponse({
        ...
        throw new Error(
          "TxClient:sendQueryAnnualProvisionsResponse: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    minter({ value }: minterParams): EncodeObject {
      try {
        return {
          ...
          value: Minter.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:Minter: Could not create message: " + e.message
        );
      }
    },
    ...
    queryInflationResponse({
      value,
    }: queryInflationResponseParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QueryInflationResponse: Could not create message: " +
            e.message
        );
      }
    },
    ...
    queryInflationRequest({
      value,
    }: queryInflationRequestParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QueryInflationRequest: Could not create message: " +
            e.message
        );
      }
    },
    ...
    queryAnnualProvisionsRequest({
      value,
    }: queryAnnualProvisionsRequestParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QueryAnnualProvisionsRequest: Could not create message: " +
            e.message
        );
      }
    },
    ...
    queryAnnualProvisionsResponse({
      value,
    }: queryAnnualProvisionsResponseParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QueryAnnualProvisionsResponse: Could not create message: " +
            e.message
        );
      }
    },
