...
export const txClient = (
  ...
  return {
    ...
    async sendQueryEvidenceRequest({
      value,
      fee,
      memo,
    }: sendQueryEvidenceRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendQueryEvidenceRequest: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.queryEvidenceRequest({
        ...
        throw new Error(
          "TxClient:sendQueryEvidenceRequest: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    async sendMsgSubmitEvidenceResponse({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgSubmitEvidenceResponse: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.msgSubmitEvidenceResponse({
        ...
        throw new Error(
          "TxClient:sendMsgSubmitEvidenceResponse: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    async sendEquivocation({
      value,
      fee,
      memo,
    }: sendEquivocationParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendEquivocation: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendEquivocation: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendQueryAllEvidenceRequest({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendQueryAllEvidenceRequest: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.queryAllEvidenceRequest({
        ...
        throw new Error(
          "TxClient:sendQueryAllEvidenceRequest: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    async sendQueryAllEvidenceResponse({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendQueryAllEvidenceResponse: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.queryAllEvidenceResponse({
        ...
        throw new Error(
          "TxClient:sendQueryAllEvidenceResponse: Could not broadcast Tx: " +
            e.message
        );
      }
    },

    async sendQueryEvidenceResponse({
      value,
      fee,
      memo,
    }: sendQueryEvidenceResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendQueryEvidenceResponse: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.queryEvidenceResponse({
        ...
        throw new Error(
          "TxClient:sendQueryEvidenceResponse: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    queryEvidenceRequest({ value }: queryEvidenceRequestParams): EncodeObject {
      try {
        ...
        throw new Error(
          "TxClient:QueryEvidenceRequest: Could not create message: " +
            e.message
        );
      }
    },
    ...
    msgSubmitEvidenceResponse({
      value,
    }: msgSubmitEvidenceResponseParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:MsgSubmitEvidenceResponse: Could not create message: " +
            e.message
        );
      }
    },
    ...
    equivocation({ value }: equivocationParams): EncodeObject {
      try {
        return {
          ...
          value: Equivocation.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:Equivocation: Could not create message: " + e.message
        );
      }
    },
    ...
    queryAllEvidenceRequest({
      value,
    }: queryAllEvidenceRequestParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QueryAllEvidenceRequest: Could not create message: " +
            e.message
        );
      }
    },
    ...
    queryAllEvidenceResponse({
      value,
    }: queryAllEvidenceResponseParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QueryAllEvidenceResponse: Could not create message: " +
            e.message
        );
      }
    },
    ...
    queryEvidenceResponse({
      value,
    }: queryEvidenceResponseParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:QueryEvidenceResponse: Could not create message: " +
            e.message
        );
      }
    },
